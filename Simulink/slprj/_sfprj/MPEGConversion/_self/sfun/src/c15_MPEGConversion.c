...
static void initialize_c15_MPEGConversion(SFc15_MPEGConversionInstanceStruct
  *chartInstance);
static void initialize_params_c15_MPEGConversion
  (SFc15_MPEGConversionInstanceStruct *chartInstance);
static void enable_c15_MPEGConversion(SFc15_MPEGConversionInstanceStruct
  *chartInstance);
static void disable_c15_MPEGConversion(SFc15_MPEGConversionInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c15_MPEGConversion
  (SFc15_MPEGConversionInstanceStruct *chartInstance);
static void set_sim_state_c15_MPEGConversion(SFc15_MPEGConversionInstanceStruct *
  chartInstance, const mxArray *c15_st);
static void finalize_c15_MPEGConversion(SFc15_MPEGConversionInstanceStruct
  *chartInstance);
static void sf_c15_MPEGConversion(SFc15_MPEGConversionInstanceStruct
  *chartInstance);
static void c15_chartstep_c15_MPEGConversion(SFc15_MPEGConversionInstanceStruct *
  chartInstance);
static void initSimStructsc15_MPEGConversion(SFc15_MPEGConversionInstanceStruct *
  chartInstance);
...
static void c15_eml_error(SFc15_MPEGConversionInstanceStruct *chartInstance);
static void c15_emlrt_marshallIn(SFc15_MPEGConversionInstanceStruct
  *chartInstance, const mxArray *c15_out, const char_T *c15_identifier, uint32_T
  c15_y[20]);
static void c15_b_emlrt_marshallIn(SFc15_MPEGConversionInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId,
  uint32_T c15_y[20]);
static void c15_c_emlrt_marshallIn(SFc15_MPEGConversionInstanceStruct
  *chartInstance, const mxArray *c15_b_prev_out, const char_T *c15_identifier,
  uint32_T c15_y[20]);
static void c15_d_emlrt_marshallIn(SFc15_MPEGConversionInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId,
  uint32_T c15_y[20]);
static uint8_T c15_e_emlrt_marshallIn(SFc15_MPEGConversionInstanceStruct
  *chartInstance, const mxArray *c15_b_is_active_c15_MPEGConversion, const
  char_T *c15_identifier);
static uint8_T c15_f_emlrt_marshallIn(SFc15_MPEGConversionInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void c15_putbits(SFc15_MPEGConversionInstanceStruct *chartInstance,
  int32_T c15_bitpos, uint32_T c15_out[20], uint32_T c15_Temp, real_T c15_outpos,
  uint32_T c15_val, real_T c15_bits, real_T *c15_flag, int32_T *c15_bitposO,
  uint32_T *c15_TempO, real_T *c15_outposO);
static void init_dsm_address_info(SFc15_MPEGConversionInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c15_is_active_c15_MPEGConversion = 0U;
  ...
  (SFc15_MPEGConversionInstanceStruct *chartInstance)
{
  ...
  c15_c_u = chartInstance->c15_is_active_c15_MPEGConversion;
  c15_d_y = NULL;
  ...
  chartInstance, const mxArray *c15_st)
{
  ...
  chartInstance->c15_is_active_c15_MPEGConversion = c15_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c15_u, 2)),
     "is_active_c15_MPEGConversion");
...
{
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  c15_chartstep_c15_MPEGConversion(chartInstance);
}
  ...
  chartInstance)
{
  ...
  c15_b_in = (real_T (*)[64])ssGetInputPortSignal(chartInstance->S, 0);
  ...
  c15_outpos = 2.0;
  if ((*c15_b_in)[0] > 0.0) {
    c15_x = muDoubleScalarFloor((*c15_b_in)[0]);
  } else {
    c15_x = muDoubleScalarCeil((*c15_b_in)[0]);
  }

  c15_x = c15_x < 0.0 ? muDoubleScalarCeil(c15_x - 0.5) : muDoubleScalarFloor
    (c15_x + 0.5);
  if (c15_x < 2.147483648E+9) {
    if (c15_x >= -2.147483648E+9) {
      c15_out1 = (int32_T)c15_x;
    } else {
      c15_out1 = MIN_int32_T;
    }
  } else if (c15_x >= 2.147483648E+9) {
  ...
  c15_x = (*c15_b_in)[1] + 0.5;
  if (c15_x > 0.0) {
    c15_x = muDoubleScalarFloor(c15_x);
  } else {
    c15_x = muDoubleScalarCeil(c15_x);
  }

  c15_pval = (real32_T)c15_x;
  ...
  do {
    c15_exitg1 = 0U;
    if (c15_bitsIn <= 64) {
      c15_x = c15_in[c15_bitsIn - 1] + 0.5;
      c15_cval = (real32_T)muDoubleScalarFloor(c15_x);
      c15_guard1 = FALSE;
      if ((c15_pval == c15_cval) && (c15_out1 < 14)) {
        ...
        c15_putbits(chartInstance, c15_bitpos, c15_out, c15_Temp, c15_outpos,
                    (uint32_T)c15_out1, 4.0, &c15_x, &c15_b_bitpos, &c15_b_Temp,
                    &c15_b_outpos);
        if (!(c15_x != 0.0)) {
          for (c15_out1 = 0; c15_out1 < 20; c15_out1++) {
          ...
          c15_putbits(chartInstance, c15_b_bitpos, c15_out, c15_b_Temp,
                      c15_b_outpos, c15_valIn, 8.0, &c15_x, &c15_bitpos,
                      &c15_Temp, &c15_outpos);
          if (!(c15_x != 0.0)) {
            for (c15_out1 = 0; c15_out1 < 20; c15_out1++) {
              chartInstance->c15_prev_out[c15_out1] = c15_out[c15_out1];
...
const mxArray *sf_c15_MPEGConversion_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c15_identifier)
{
  ...
  c15_y = c15_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c15_b_is_active_c15_MPEGConversion), &c15_thisId);
  sf_mex_destroy(&c15_b_is_active_c15_MPEGConversion);
  return c15_y;
}
...
/* SFunction Glue Code */
void sf_c15_MPEGConversion_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c15_MPEGConversion_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c15_MPEGConversion(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"out\",},{M[4],M[0],T\"prev_out\",S'l','i','p'{{M1x2[264 272],M[0],}}},{M[8],M[0],T\"is_active_c15_MPEGConversion\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c15_MPEGConversion_get_check_sum(&mxChecksum);
  mxSetField(mxInfo, 0, infoFields[0], mxChecksum);
  mxSetField(mxInfo, 0, infoFields[1], mxVarInfo);
  return mxInfo;
}

static void sf_opaque_initialize_c15_MPEGConversion(void *chartInstanceVar)
{
  initialize_params_c15_MPEGConversion((SFc15_MPEGConversionInstanceStruct*)
    chartInstanceVar);
  initialize_c15_MPEGConversion((SFc15_MPEGConversionInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c15_MPEGConversion(void *chartInstanceVar)
{
  enable_c15_MPEGConversion((SFc15_MPEGConversionInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c15_MPEGConversion(void *chartInstanceVar)
{
  disable_c15_MPEGConversion((SFc15_MPEGConversionInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c15_MPEGConversion(void *chartInstanceVar)
{
  sf_c15_MPEGConversion((SFc15_MPEGConversionInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c15_MPEGConversion(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c15_MPEGConversion
    ((SFc15_MPEGConversionInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c15_MPEGConversion();/* state var info */
...
extern void sf_internal_set_sim_state_c15_MPEGConversion(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c15_MPEGConversion((SFc15_MPEGConversionInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c15_MPEGConversion(SimStruct* S)
{
  return sf_internal_get_sim_state_c15_MPEGConversion(S);
}

static void sf_opaque_set_sim_state_c15_MPEGConversion(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c15_MPEGConversion(S, st);
}

static void sf_opaque_terminate_c15_MPEGConversion(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc15_MPEGConversionInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c15_MPEGConversion((SFc15_MPEGConversionInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc15_MPEGConversion((SFc15_MPEGConversionInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c15_MPEGConversion(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c15_MPEGConversion(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"MPEGConversion","MPEGConversion",15);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"MPEGConversion","MPEGConversion",15,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"MPEGConversion",
      "MPEGConversion",15,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"MPEGConversion","MPEGConversion",15,
        1);
      sf_mark_chart_reusable_outputs(S,"MPEGConversion","MPEGConversion",15,1);
    }

    sf_set_rtw_dwork_info(S,"MPEGConversion","MPEGConversion",15);
...
static void mdlRTW_c15_MPEGConversion(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "MPEGConversion", "MPEGConversion",15);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c15_MPEGConversion(SimStruct *S)
{
  SFc15_MPEGConversionInstanceStruct *chartInstance;
  chartInstance = (SFc15_MPEGConversionInstanceStruct *)malloc(sizeof
    (SFc15_MPEGConversionInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc15_MPEGConversionInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c15_MPEGConversion;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c15_MPEGConversion;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c15_MPEGConversion;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c15_MPEGConversion;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c15_MPEGConversion;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c15_MPEGConversion;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c15_MPEGConversion;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c15_MPEGConversion;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c15_MPEGConversion;
  chartInstance->chartInfo.mdlStart = mdlStart_c15_MPEGConversion;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c15_MPEGConversion;
...
void c15_MPEGConversion_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c15_MPEGConversion(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c15_MPEGConversion(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c15_MPEGConversion(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c15_MPEGConversion_method_dispatcher.\n"
