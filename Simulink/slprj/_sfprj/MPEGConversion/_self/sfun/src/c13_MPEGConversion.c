...
static void initialize_c13_MPEGConversion(SFc13_MPEGConversionInstanceStruct
  *chartInstance);
static void initialize_params_c13_MPEGConversion
  (SFc13_MPEGConversionInstanceStruct *chartInstance);
static void enable_c13_MPEGConversion(SFc13_MPEGConversionInstanceStruct
  *chartInstance);
static void disable_c13_MPEGConversion(SFc13_MPEGConversionInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c13_MPEGConversion
  (SFc13_MPEGConversionInstanceStruct *chartInstance);
static void set_sim_state_c13_MPEGConversion(SFc13_MPEGConversionInstanceStruct *
  chartInstance, const mxArray *c13_st);
static void finalize_c13_MPEGConversion(SFc13_MPEGConversionInstanceStruct
  *chartInstance);
static void sf_c13_MPEGConversion(SFc13_MPEGConversionInstanceStruct
  *chartInstance);
static void c13_chartstep_c13_MPEGConversion(SFc13_MPEGConversionInstanceStruct *
  chartInstance);
static void initSimStructsc13_MPEGConversion(SFc13_MPEGConversionInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c13_machineNumber, uint32_T
  c13_chartNumber);
static void c13_info_helper(c13_ResolvedFunctionInfo c13_info[16]);
static void c13_eml_error(SFc13_MPEGConversionInstanceStruct *chartInstance);
static void c13_emlrt_marshallIn(SFc13_MPEGConversionInstanceStruct
  *chartInstance, const mxArray *c13_out, const char_T *c13_identifier, uint32_T
  c13_y[20]);
static void c13_b_emlrt_marshallIn(SFc13_MPEGConversionInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId,
  uint32_T c13_y[20]);
static void c13_c_emlrt_marshallIn(SFc13_MPEGConversionInstanceStruct
  *chartInstance, const mxArray *c13_b_prev_out, const char_T *c13_identifier,
  uint32_T c13_y[20]);
static void c13_d_emlrt_marshallIn(SFc13_MPEGConversionInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId,
  uint32_T c13_y[20]);
static uint8_T c13_e_emlrt_marshallIn(SFc13_MPEGConversionInstanceStruct
  *chartInstance, const mxArray *c13_b_is_active_c13_MPEGConversion, const
  char_T *c13_identifier);
static uint8_T c13_f_emlrt_marshallIn(SFc13_MPEGConversionInstanceStruct
  *chartInstance, const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void c13_putbits(SFc13_MPEGConversionInstanceStruct *chartInstance,
  int32_T c13_bitpos, uint32_T c13_out[20], uint32_T c13_Temp, real_T c13_outpos,
  uint32_T c13_val, real_T c13_bits, real_T *c13_flag, int32_T *c13_bitposO,
  uint32_T *c13_TempO, real_T *c13_outposO);
static void init_dsm_address_info(SFc13_MPEGConversionInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_MPEGConversion = 0U;
  ...
  (SFc13_MPEGConversionInstanceStruct *chartInstance)
{
  ...
  c13_c_u = chartInstance->c13_is_active_c13_MPEGConversion;
  c13_d_y = NULL;
  ...
  chartInstance, const mxArray *c13_st)
{
  ...
  chartInstance->c13_is_active_c13_MPEGConversion = c13_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c13_u, 2)),
     "is_active_c13_MPEGConversion");
...
{
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  c13_chartstep_c13_MPEGConversion(chartInstance);
}
...
const mxArray *sf_c13_MPEGConversion_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c13_identifier)
{
  ...
  c13_y = c13_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_MPEGConversion), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_MPEGConversion);
  return c13_y;
}
...
/* SFunction Glue Code */
void sf_c13_MPEGConversion_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c13_MPEGConversion_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c13_MPEGConversion(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"out\",},{M[4],M[0],T\"prev_out\",S'l','i','p'{{M1x2[264 272],M[0],}}},{M[8],M[0],T\"is_active_c13_MPEGConversion\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_MPEGConversion_get_check_sum(&mxChecksum);
  mxSetField(mxInfo, 0, infoFields[0], mxChecksum);
  mxSetField(mxInfo, 0, infoFields[1], mxVarInfo);
  return mxInfo;
}

static void sf_opaque_initialize_c13_MPEGConversion(void *chartInstanceVar)
{
  initialize_params_c13_MPEGConversion((SFc13_MPEGConversionInstanceStruct*)
    chartInstanceVar);
  initialize_c13_MPEGConversion((SFc13_MPEGConversionInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c13_MPEGConversion(void *chartInstanceVar)
{
  enable_c13_MPEGConversion((SFc13_MPEGConversionInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c13_MPEGConversion(void *chartInstanceVar)
{
  disable_c13_MPEGConversion((SFc13_MPEGConversionInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c13_MPEGConversion(void *chartInstanceVar)
{
  sf_c13_MPEGConversion((SFc13_MPEGConversionInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c13_MPEGConversion(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_MPEGConversion
    ((SFc13_MPEGConversionInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c13_MPEGConversion();/* state var info */
...
extern void sf_internal_set_sim_state_c13_MPEGConversion(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c13_MPEGConversion((SFc13_MPEGConversionInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c13_MPEGConversion(SimStruct* S)
{
  return sf_internal_get_sim_state_c13_MPEGConversion(S);
}

static void sf_opaque_set_sim_state_c13_MPEGConversion(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c13_MPEGConversion(S, st);
}

static void sf_opaque_terminate_c13_MPEGConversion(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_MPEGConversionInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c13_MPEGConversion((SFc13_MPEGConversionInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc13_MPEGConversion((SFc13_MPEGConversionInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_MPEGConversion(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c13_MPEGConversion(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"MPEGConversion","MPEGConversion",13);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"MPEGConversion","MPEGConversion",13,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"MPEGConversion",
      "MPEGConversion",13,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"MPEGConversion","MPEGConversion",13,
        1);
      sf_mark_chart_reusable_outputs(S,"MPEGConversion","MPEGConversion",13,1);
    }

    sf_set_rtw_dwork_info(S,"MPEGConversion","MPEGConversion",13);
...
static void mdlRTW_c13_MPEGConversion(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "MPEGConversion", "MPEGConversion",13);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c13_MPEGConversion(SimStruct *S)
{
  SFc13_MPEGConversionInstanceStruct *chartInstance;
  chartInstance = (SFc13_MPEGConversionInstanceStruct *)malloc(sizeof
    (SFc13_MPEGConversionInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc13_MPEGConversionInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c13_MPEGConversion;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c13_MPEGConversion;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c13_MPEGConversion;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c13_MPEGConversion;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c13_MPEGConversion;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c13_MPEGConversion;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c13_MPEGConversion;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c13_MPEGConversion;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_MPEGConversion;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_MPEGConversion;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c13_MPEGConversion;
...
void c13_MPEGConversion_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_MPEGConversion(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_MPEGConversion(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_MPEGConversion(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_MPEGConversion_method_dispatcher.\n"
