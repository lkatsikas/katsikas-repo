...
static void initialize_c5_YCbCrTesting(SFc5_YCbCrTestingInstanceStruct
  *chartInstance);
static void initialize_params_c5_YCbCrTesting(SFc5_YCbCrTestingInstanceStruct
  *chartInstance);
static void enable_c5_YCbCrTesting(SFc5_YCbCrTestingInstanceStruct
  *chartInstance);
static void disable_c5_YCbCrTesting(SFc5_YCbCrTestingInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c5_YCbCrTesting
  (SFc5_YCbCrTestingInstanceStruct *chartInstance);
static void set_sim_state_c5_YCbCrTesting(SFc5_YCbCrTestingInstanceStruct
  *chartInstance, const mxArray *c5_st);
static void finalize_c5_YCbCrTesting(SFc5_YCbCrTestingInstanceStruct
  *chartInstance);
static void sf_c5_YCbCrTesting(SFc5_YCbCrTestingInstanceStruct *chartInstance);
static void initSimStructsc5_YCbCrTesting(SFc5_YCbCrTestingInstanceStruct
  *chartInstance);
static void init_script_number_translation(uint32_T c5_machineNumber, uint32_T
  c5_chartNumber);
static void c5_info_helper(c5_ResolvedFunctionInfo c5_info[17]);
static void c5_getbits(SFc5_YCbCrTestingInstanceStruct *chartInstance, int32_T
...
static void c5_eml_error(SFc5_YCbCrTestingInstanceStruct *chartInstance);
static void c5_emlrt_marshallIn(SFc5_YCbCrTestingInstanceStruct *chartInstance,
  const mxArray *c5_out, const char_T *c5_identifier, real32_T c5_y[64]);
static void c5_b_emlrt_marshallIn(SFc5_YCbCrTestingInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real32_T c5_y[64]);
static void c5_c_emlrt_marshallIn(SFc5_YCbCrTestingInstanceStruct *chartInstance,
  const mxArray *c5_b_prev_out, const char_T *c5_identifier, real32_T c5_y[64]);
static void c5_d_emlrt_marshallIn(SFc5_YCbCrTestingInstanceStruct *chartInstance,
  const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId, real32_T c5_y[64]);
static uint8_T c5_e_emlrt_marshallIn(SFc5_YCbCrTestingInstanceStruct
  *chartInstance, const mxArray *c5_b_is_active_c5_YCbCrTesting, const char_T
  *c5_identifier);
static uint8_T c5_f_emlrt_marshallIn(SFc5_YCbCrTestingInstanceStruct
  *chartInstance, const mxArray *c5_u, const emlrtMsgIdentifier *c5_parentId);
static void init_dsm_address_info(SFc5_YCbCrTestingInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c5_is_active_c5_YCbCrTesting = 0U;
  ...
  (SFc5_YCbCrTestingInstanceStruct *chartInstance)
{
  ...
  c5_c_u = chartInstance->c5_is_active_c5_YCbCrTesting;
  c5_d_y = NULL;
...
const mxArray *sf_c5_YCbCrTesting_get_eml_resolved_functions_info(void)
{
  ...
  *c5_identifier)
{
  ...
  c5_y = c5_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c5_b_is_active_c5_YCbCrTesting), &c5_thisId);
  sf_mex_destroy(&c5_b_is_active_c5_YCbCrTesting);
  return c5_y;
}
...
/* SFunction Glue Code */
void sf_c5_YCbCrTesting_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c5_YCbCrTesting_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c5_YCbCrTesting(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"out\",},{M[4],M[0],T\"prev_out\",S'l','i','p'{{M1x2[188 196],M[0],}}},{M[8],M[0],T\"is_active_c5_YCbCrTesting\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c5_YCbCrTesting_get_check_sum(&mxChecksum);
  mxSetField(mxInfo, 0, infoFields[0], mxChecksum);
  mxSetField(mxInfo, 0, infoFields[1], mxVarInfo);
  return mxInfo;
}

static void sf_opaque_initialize_c5_YCbCrTesting(void *chartInstanceVar)
{
  initialize_params_c5_YCbCrTesting((SFc5_YCbCrTestingInstanceStruct*)
    chartInstanceVar);
  initialize_c5_YCbCrTesting((SFc5_YCbCrTestingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c5_YCbCrTesting(void *chartInstanceVar)
{
  enable_c5_YCbCrTesting((SFc5_YCbCrTestingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c5_YCbCrTesting(void *chartInstanceVar)
{
  disable_c5_YCbCrTesting((SFc5_YCbCrTestingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c5_YCbCrTesting(void *chartInstanceVar)
{
  sf_c5_YCbCrTesting((SFc5_YCbCrTestingInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c5_YCbCrTesting(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c5_YCbCrTesting
    ((SFc5_YCbCrTestingInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c5_YCbCrTesting();/* state var info */
...
extern void sf_internal_set_sim_state_c5_YCbCrTesting(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c5_YCbCrTesting((SFc5_YCbCrTestingInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c5_YCbCrTesting(SimStruct* S)
{
  return sf_internal_get_sim_state_c5_YCbCrTesting(S);
}

static void sf_opaque_set_sim_state_c5_YCbCrTesting(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c5_YCbCrTesting(S, st);
}

static void sf_opaque_terminate_c5_YCbCrTesting(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc5_YCbCrTestingInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c5_YCbCrTesting((SFc5_YCbCrTestingInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc5_YCbCrTesting((SFc5_YCbCrTestingInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c5_YCbCrTesting(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c5_YCbCrTesting(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"YCbCrTesting","YCbCrTesting",5);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"YCbCrTesting","YCbCrTesting",5,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"YCbCrTesting",
      "YCbCrTesting",5,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"YCbCrTesting","YCbCrTesting",5,1);
      sf_mark_chart_reusable_outputs(S,"YCbCrTesting","YCbCrTesting",5,1);
    }

    sf_set_rtw_dwork_info(S,"YCbCrTesting","YCbCrTesting",5);
...
static void mdlRTW_c5_YCbCrTesting(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "YCbCrTesting", "YCbCrTesting",5);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c5_YCbCrTesting(SimStruct *S)
{
  SFc5_YCbCrTestingInstanceStruct *chartInstance;
  chartInstance = (SFc5_YCbCrTestingInstanceStruct *)malloc(sizeof
    (SFc5_YCbCrTestingInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc5_YCbCrTestingInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c5_YCbCrTesting;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c5_YCbCrTesting;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c5_YCbCrTesting;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c5_YCbCrTesting;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c5_YCbCrTesting;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c5_YCbCrTesting;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c5_YCbCrTesting;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c5_YCbCrTesting;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c5_YCbCrTesting;
  chartInstance->chartInfo.mdlStart = mdlStart_c5_YCbCrTesting;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c5_YCbCrTesting;
...
void c5_YCbCrTesting_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c5_YCbCrTesting(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c5_YCbCrTesting(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c5_YCbCrTesting(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c5_YCbCrTesting_method_dispatcher.\n"
