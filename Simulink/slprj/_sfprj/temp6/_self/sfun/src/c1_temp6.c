...
#include "temp6_sfun_debug_macros.h"
...
static void initialize_c1_temp6(SFc1_temp6InstanceStruct *chartInstance);
static void initialize_params_c1_temp6(SFc1_temp6InstanceStruct *chartInstance);
static void enable_c1_temp6(SFc1_temp6InstanceStruct *chartInstance);
static void disable_c1_temp6(SFc1_temp6InstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_temp6(SFc1_temp6InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_temp6(SFc1_temp6InstanceStruct
  *chartInstance);
static void set_sim_state_c1_temp6(SFc1_temp6InstanceStruct *chartInstance,
  const mxArray *c1_st);
static void finalize_c1_temp6(SFc1_temp6InstanceStruct *chartInstance);
static void sf_c1_temp6(SFc1_temp6InstanceStruct *chartInstance);
static void c1_chartstep_c1_temp6(SFc1_temp6InstanceStruct *chartInstance);
static void initSimStructsc1_temp6(SFc1_temp6InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_temp6InstanceStruct *chartInstance, const
  mxArray *c1_data_out, const char_T *c1_identifier, creal_T c1_y[115940]);
static void c1_b_emlrt_marshallIn(SFc1_temp6InstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, creal_T c1_y[115940]);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_temp6InstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  c1_struct_xiTGusujfWbfyD0i7ym1G *c1_y);
static real_T c1_d_emlrt_marshallIn(SFc1_temp6InstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_emlrt_marshallIn(SFc1_temp6InstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[1705]);
static void c1_f_emlrt_marshallIn(SFc1_temp6InstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[45]);
static void c1_g_emlrt_marshallIn(SFc1_temp6InstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[17]);
static void c1_h_emlrt_marshallIn(SFc1_temp6InstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[142]);
static void c1_i_emlrt_marshallIn(SFc1_temp6InstanceStruct *chartInstance, const
...
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_j_emlrt_marshallIn(SFc1_temp6InstanceStruct *chartInstance, const
...
static const mxArray *c1_i_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_k_emlrt_marshallIn(SFc1_temp6InstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_h_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_l_emlrt_marshallIn(SFc1_temp6InstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_temp6, const char_T *c1_identifier);
static uint8_T c1_m_emlrt_marshallIn(SFc1_temp6InstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_temp6InstanceStruct *chartInstance);
...
static void initialize_c1_temp6(SFc1_temp6InstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_temp6 = 0U;
}
  ...
  *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_temp6;
  ...
  const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_temp6 = c1_l_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 1)), "is_active_c1_temp6");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_temp6(chartInstance);
...
static void sf_c1_temp6(SFc1_temp6InstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_temp6(chartInstance);
  sf_debug_check_for_state_inconsistency(_temp6MachineNumber_,
...
static void c1_chartstep_c1_temp6(SFc1_temp6InstanceStruct *chartInstance)
{
  ...
  sf_mex_printf("%s =\\n", "ans");
  for (c1_i8 = 0; c1_i8 < 1705; c1_i8++) {
    c1_c_u[c1_i8] = c1_data_out[c1_i8];
  }

  c1_y = NULL;
  sf_mex_assign(&c1_y, sf_mex_create("y", c1_c_u, 0, 1U, 1U, 0U, 1, 1705));
  sf_mex_call_debug("disp", 0U, 1U, 14, c1_y);
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, -40);
  sf_debug_symbol_scope_pop();
  for (c1_i9 = 0; c1_i9 < 115940; c1_i9++) {
    (*c1_b_data_out)[c1_i9] = c1_data_out[c1_i9];
  }
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  static creal_T c1_u[115940];
  const mxArray *c1_y = NULL;
  SFc1_temp6InstanceStruct *chartInstance;
  chartInstance = (SFc1_temp6InstanceStruct *)chartInstanceVoid;
  c1_mxArrayOutData = NULL;
  c1_i10 = 0;
  for (c1_i11 = 0; c1_i11 < 68; c1_i11++) {
    for (c1_i12 = 0; c1_i12 < 1705; c1_i12++) {
      c1_b_inData[c1_i12 + c1_i10] = (*(creal_T (*)[115940])c1_inData)[c1_i12 +
        c1_i10];
    }
  ...
  c1_i13 = 0;
  for (c1_i14 = 0; c1_i14 < 68; c1_i14++) {
    for (c1_i15 = 0; c1_i15 < 1705; c1_i15++) {
  ...
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, creal_T c1_y[115940])
{
  ...
  sf_mex_import(c1_parentId, sf_mex_dup(c1_u), c1_dcv1, 1, 0, 1U, 1, 0U, 2, 1705,
                68);
  for (c1_i16 = 0; c1_i16 < 115940; c1_i16++) {
    c1_y[c1_i16] = c1_dcv1[c1_i16];
  }
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  sf_mex_destroy(&c1_data_out);
  c1_i17 = 0;
  for (c1_i18 = 0; c1_i18 < 68; c1_i18++) {
    for (c1_i19 = 0; c1_i19 < 1705; c1_i19++) {
      (*(creal_T (*)[115940])c1_outData)[c1_i19 + c1_i17] = c1_y[c1_i19 + c1_i17];
    }
  ...
  *c1_inData)
{
  ...
  for (c1_i20 = 0; c1_i20 < 1705; c1_i20++) {
    c1_c_u[c1_i20] = c1_u.w[c1_i20];
  }

  c1_c_y = NULL;
  sf_mex_assign(&c1_c_y, sf_mex_create("y", c1_c_u, 0, 0U, 1U, 0U, 2, 1, 1705));
  sf_mex_addfield(c1_y, c1_c_y, "w", "w", 0);
  for (c1_i21 = 0; c1_i21 < 45; c1_i21++) {
    c1_d_u[c1_i21] = c1_u.continual_pilots[c1_i21];
  }
  ...
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[1705])
{
  ...
  sf_mex_import(c1_parentId, sf_mex_dup(c1_u), c1_dv0, 1, 0, 0U, 1, 0U, 2, 1,
                1705);
  for (c1_i25 = 0; c1_i25 < 1705; c1_i25++) {
  ...
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[45])
{
  ...
  for (c1_i26 = 0; c1_i26 < 45; c1_i26++) {
    c1_y[c1_i26] = c1_dv1[c1_i26];
  }
  ...
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[142])
{
  ...
  sf_mex_import(c1_parentId, sf_mex_dup(c1_u), c1_dv3, 1, 0, 0U, 1, 0U, 2, 1,
                142);
  for (c1_i28 = 0; c1_i28 < 142; c1_i28++) {
  ...
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[11968])
{
  ...
  sf_mex_import(c1_parentId, sf_mex_dup(c1_u), c1_dv4, 1, 0, 0U, 1, 0U, 2, 176,
                68);
  for (c1_i29 = 0; c1_i29 < 11968; c1_i29++) {
    c1_y[c1_i29] = c1_dv4[c1_i29];
  }
  ...
  *c1_inData)
{
  ...
  c1_mxArrayOutData = NULL;
  c1_i30 = 0;
  for (c1_i31 = 0; c1_i31 < 68; c1_i31++) {
    for (c1_i32 = 0; c1_i32 < 1512; c1_i32++) {
      c1_b_inData[c1_i32 + c1_i30] = (*(creal_T (*)[102816])c1_inData)[c1_i32 +
        c1_i30];
    }
  ...
  *c1_inData)
{
  ...
  for (c1_i37 = 0; c1_i37 < 68; c1_i37++) {
    for (c1_i38 = 0; c1_i38 < 1705; c1_i38++) {
      c1_b_inData[c1_i38 + c1_i36] = (*(real_T (*)[115940])c1_inData)[c1_i38 +
        c1_i36];
    }
...
static void c1_j_emlrt_marshallIn(SFc1_temp6InstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[115940])
{
  static real_T c1_dv5[115940];
  int32_T c1_i42;
  sf_mex_import(c1_parentId, sf_mex_dup(c1_u), c1_dv5, 1, 0, 0U, 1, 0U, 2, 1705,
                68);
  for (c1_i42 = 0; c1_i42 < 115940; c1_i42++) {
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_j_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_temp), &c1_thisId, c1_y);
  sf_mex_destroy(&c1_temp);
  c1_i43 = 0;
  for (c1_i44 = 0; c1_i44 < 68; c1_i44++) {
    for (c1_i45 = 0; c1_i45 < 1705; c1_i45++) {
      (*(real_T (*)[115940])c1_outData)[c1_i45 + c1_i43] = c1_y[c1_i45 + c1_i43];
    }
  ...
  *c1_inData)
{
  ...
  for (c1_i47 = 0; c1_i47 < 68; c1_i47++) {
    for (c1_i48 = 0; c1_i48 < 176; c1_i48++) {
      c1_b_inData[c1_i48 + c1_i46] = (*(real_T (*)[11968])c1_inData)[c1_i48 +
        c1_i46];
    }
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  for (c1_i53 = 0; c1_i53 < 68; c1_i53++) {
    for (c1_i54 = 0; c1_i54 < 176; c1_i54++) {
      (*(real_T (*)[11968])c1_outData)[c1_i54 + c1_i52] = c1_y[c1_i54 + c1_i52];
    }
  ...
  *c1_inData)
{
  ...
  chartInstance = (SFc1_temp6InstanceStruct *)chartInstanceVoid;
  c1_mxArrayOutData = NULL;
  for (c1_i55 = 0; c1_i55 < 17; c1_i55++) {
    c1_b_inData[c1_i55] = (*(real_T (*)[17])c1_inData)[c1_i55];
  }

  for (c1_i56 = 0; c1_i56 < 17; c1_i56++) {
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  for (c1_i57 = 0; c1_i57 < 17; c1_i57++) {
    (*(real_T (*)[17])c1_outData)[c1_i57] = c1_y[c1_i57];
  }
  ...
  *c1_inData)
{
  ...
  chartInstance = (SFc1_temp6InstanceStruct *)chartInstanceVoid;
  c1_mxArrayOutData = NULL;
  for (c1_i58 = 0; c1_i58 < 1705; c1_i58++) {
    c1_b_inData[c1_i58] = (*(real_T (*)[1705])c1_inData)[c1_i58];
  }

  for (c1_i59 = 0; c1_i59 < 1705; c1_i59++) {
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  sf_mex_destroy(&c1_w);
  for (c1_i60 = 0; c1_i60 < 1705; c1_i60++) {
    (*(real_T (*)[1705])c1_outData)[c1_i60] = c1_y[c1_i60];
  }

  sf_mex_destroy(&c1_mxArrayInData);
}

const mxArray *sf_c1_temp6_get_eml_resolved_functions_info(void)
{
  ...
  for (c1_i61 = 0; c1_i61 < 5; c1_i61++) {
    ...
    sf_mex_addfield(c1_m1, sf_mex_create("nameCaptureInfo", c1_r1->name, 15, 0U,
      0U, 0U, 2, 1, strlen(c1_r1->name)), "name", "nameCaptureInfo", c1_i61);
  ...
  const mxArray *c1_b_is_active_c1_temp6, const char_T *c1_identifier)
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_y = c1_m_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_b_is_active_c1_temp6),
    &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_temp6);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_temp6_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3886438870U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3929651055U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2747974404U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1889258333U);
}

mxArray *sf_c1_temp6_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(2768056114U);
    pr[1] = (double)(760076802U);
    pr[2] = (double)(1440868989U);
    pr[3] = (double)(4018468921U);
...
static const mxArray *sf_get_sim_state_info_c1_temp6(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"data_out\",},{M[8],M[0],T\"is_active_c1_temp6\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_temp6_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_temp6InstanceStruct *chartInstance;
    chartInstance = (SFc1_temp6InstanceStruct *) ((ChartInfoStruct *)
      (ssGetUserData(S)))->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        unsigned int chartAlreadyPresent;
        chartAlreadyPresent = sf_debug_initialize_chart(_temp6MachineNumber_,
          1,
          1,
          1,
          3,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_temp6MachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting(_temp6MachineNumber_,
            chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_temp6MachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
        ...
        _SFD_CV_INIT_EML_IF(0,1,687,696,860,1142);
        _SFD_CV_INIT_EML_IF(0,2,860,873,1026,1142);
        _SFD_CV_INIT_EML_FOR(0,0,260,276,1160);
        _SFD_CV_INIT_EML_FOR(0,1,425,449,1154);
      ...
      sf_debug_reset_current_state_configuration(_temp6MachineNumber_,
        chartInstance->chartNumber,chartInstance->instanceNumber);
    }
  }
}

static void sf_opaque_initialize_c1_temp6(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_temp6InstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c1_temp6((SFc1_temp6InstanceStruct*) chartInstanceVar);
  initialize_c1_temp6((SFc1_temp6InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_temp6(void *chartInstanceVar)
{
  enable_c1_temp6((SFc1_temp6InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_temp6(void *chartInstanceVar)
{
  disable_c1_temp6((SFc1_temp6InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_temp6(void *chartInstanceVar)
{
  sf_c1_temp6((SFc1_temp6InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_temp6(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_temp6((SFc1_temp6InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_temp6();/* state var info */
...
extern void sf_internal_set_sim_state_c1_temp6(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_temp6((SFc1_temp6InstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_temp6(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_temp6(S);
}

static void sf_opaque_set_sim_state_c1_temp6(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_temp6(S, st);
}

static void sf_opaque_terminate_c1_temp6(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_temp6InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_temp6((SFc1_temp6InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_temp6((SFc1_temp6InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_temp6(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_temp6((SFc1_temp6InstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_temp6(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"temp6","temp6",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"temp6","temp6",1,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"temp6","temp6",1,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"temp6","temp6",1,1);
      sf_mark_chart_reusable_outputs(S,"temp6","temp6",1,1);
    }

    sf_set_rtw_dwork_info(S,"temp6","temp6",1);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
  } else {
  }

  ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  ssSetChecksum0(S,(3583075857U));
  ssSetChecksum1(S,(1825243758U));
  ssSetChecksum2(S,(3988398098U));
  ssSetChecksum3(S,(3745332308U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c1_temp6(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "temp6", "temp6",1);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c1_temp6(SimStruct *S)
{
  SFc1_temp6InstanceStruct *chartInstance;
  chartInstance = (SFc1_temp6InstanceStruct *)malloc(sizeof
    (SFc1_temp6InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_temp6InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_temp6;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_temp6;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_temp6;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_temp6;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_temp6;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_temp6;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_temp6;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_temp6;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_temp6;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_temp6;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_temp6;
...
void c1_temp6_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_temp6(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_temp6(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_temp6_method_dispatcher.\n"
