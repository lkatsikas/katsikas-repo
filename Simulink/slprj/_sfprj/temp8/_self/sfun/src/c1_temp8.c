...
#include "temp8_sfun_debug_macros.h"
...
static void initialize_c1_temp8(SFc1_temp8InstanceStruct *chartInstance);
static void initialize_params_c1_temp8(SFc1_temp8InstanceStruct *chartInstance);
static void enable_c1_temp8(SFc1_temp8InstanceStruct *chartInstance);
static void disable_c1_temp8(SFc1_temp8InstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_temp8(SFc1_temp8InstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_temp8(SFc1_temp8InstanceStruct
  *chartInstance);
static void set_sim_state_c1_temp8(SFc1_temp8InstanceStruct *chartInstance,
  const mxArray *c1_st);
static void finalize_c1_temp8(SFc1_temp8InstanceStruct *chartInstance);
static void sf_c1_temp8(SFc1_temp8InstanceStruct *chartInstance);
static void c1_chartstep_c1_temp8(SFc1_temp8InstanceStruct *chartInstance);
static void initSimStructsc1_temp8(SFc1_temp8InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_temp8InstanceStruct *chartInstance, const
  mxArray *c1_data_out, const char_T *c1_identifier, creal_T c1_y[115940]);
static void c1_b_emlrt_marshallIn(SFc1_temp8InstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, creal_T c1_y[115940]);
static void c1_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_c_emlrt_marshallIn(SFc1_temp8InstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  c1_struct_pff9OPVgTqbyCupd3ePNxF *c1_y);
static void c1_d_emlrt_marshallIn(SFc1_temp8InstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[1705]);
static void c1_e_emlrt_marshallIn(SFc1_temp8InstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[45]);
static void c1_f_emlrt_marshallIn(SFc1_temp8InstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[17]);
static void c1_g_emlrt_marshallIn(SFc1_temp8InstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[142]);
static void c1_h_emlrt_marshallIn(SFc1_temp8InstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[11968]);
static void c1_i_emlrt_marshallIn(SFc1_temp8InstanceStruct *chartInstance, const
  mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_y[2560]);
static void c1_j_emlrt_marshallIn(SFc1_temp8InstanceStruct *chartInstance, const
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_k_emlrt_marshallIn(SFc1_temp8InstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_l_emlrt_marshallIn(SFc1_temp8InstanceStruct *chartInstance, const
...
static const mxArray *c1_i_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_m_emlrt_marshallIn(SFc1_temp8InstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_h_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_n_emlrt_marshallIn(SFc1_temp8InstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_temp8, const char_T *c1_identifier);
static uint8_T c1_o_emlrt_marshallIn(SFc1_temp8InstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_temp8InstanceStruct *chartInstance);
...
static void initialize_c1_temp8(SFc1_temp8InstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_temp8 = 0U;
}
  ...
  *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_temp8;
  ...
  const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_temp8 = c1_n_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 1)), "is_active_c1_temp8");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_temp8(chartInstance);
...
static void sf_c1_temp8(SFc1_temp8InstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_temp8(chartInstance);
  sf_debug_check_for_state_inconsistency(_temp8MachineNumber_,
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  static creal_T c1_u[115940];
  const mxArray *c1_y = NULL;
  SFc1_temp8InstanceStruct *chartInstance;
  chartInstance = (SFc1_temp8InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_temp8_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c1_b_is_active_c1_temp8, const char_T *c1_identifier)
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_y = c1_o_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_b_is_active_c1_temp8),
    &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_temp8);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_temp8_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_temp8_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_temp8(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"data_out\",},{M[8],M[0],T\"is_active_c1_temp8\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_temp8_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_temp8InstanceStruct *chartInstance;
    chartInstance = (SFc1_temp8InstanceStruct *) ((ChartInfoStruct *)
      (ssGetUserData(S)))->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        unsigned int chartAlreadyPresent;
        chartAlreadyPresent = sf_debug_initialize_chart(_temp8MachineNumber_,
          1,
          1,
          1,
          3,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_temp8MachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting(_temp8MachineNumber_,
            chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_temp8MachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
      ...
      sf_debug_reset_current_state_configuration(_temp8MachineNumber_,
        chartInstance->chartNumber,chartInstance->instanceNumber);
    }
  }
}

static void sf_opaque_initialize_c1_temp8(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_temp8InstanceStruct*) chartInstanceVar)->S,0);
  initialize_params_c1_temp8((SFc1_temp8InstanceStruct*) chartInstanceVar);
  initialize_c1_temp8((SFc1_temp8InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_temp8(void *chartInstanceVar)
{
  enable_c1_temp8((SFc1_temp8InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_temp8(void *chartInstanceVar)
{
  disable_c1_temp8((SFc1_temp8InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_temp8(void *chartInstanceVar)
{
  sf_c1_temp8((SFc1_temp8InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_temp8(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_temp8((SFc1_temp8InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_temp8();/* state var info */
...
extern void sf_internal_set_sim_state_c1_temp8(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_temp8((SFc1_temp8InstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_temp8(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_temp8(S);
}

static void sf_opaque_set_sim_state_c1_temp8(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_temp8(S, st);
}

static void sf_opaque_terminate_c1_temp8(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_temp8InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_temp8((SFc1_temp8InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_temp8((SFc1_temp8InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_temp8(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_temp8((SFc1_temp8InstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_temp8(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"temp8","temp8",1);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"temp8","temp8",1,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"temp8","temp8",1,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"temp8","temp8",1,1);
      sf_mark_chart_reusable_outputs(S,"temp8","temp8",1,1);
    }

    sf_set_rtw_dwork_info(S,"temp8","temp8",1);
...
static void mdlRTW_c1_temp8(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "temp8", "temp8",1);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c1_temp8(SimStruct *S)
{
  SFc1_temp8InstanceStruct *chartInstance;
  chartInstance = (SFc1_temp8InstanceStruct *)malloc(sizeof
    (SFc1_temp8InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_temp8InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_temp8;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_temp8;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_temp8;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_temp8;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_temp8;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_temp8;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_temp8;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_temp8;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_temp8;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_temp8;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_temp8;
...
void c1_temp8_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   ...
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_temp8(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_temp8(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_temp8_method_dispatcher.\n"
