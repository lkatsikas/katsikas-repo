#ifndef __c1_commsdrhw_h__
#define __c1_commsdrhw_h__
...
typedef struct sgyjHZtUMVZuM1aKBgGok1D
{
  ...
  real_T ScaleI;
  real_T ScaleQ;
} c1_sgyjHZtUMVZuM1aKBgGok1D;

#else

typedef struct sgyjHZtUMVZuM1aKBgGok1D c1_sgyjHZtUMVZuM1aKBgGok1D;
...
typedef enum USRP2Opcodes c1_USRP2Opcodes;
...
typedef enum USRP2FieldDtypes c1_USRP2FieldDtypes;
...
typedef enum USRP2CmdFields c1_USRP2CmdFields;
...
typedef struct s7P91ApZ2CkwDPZE5FamWSB
{
  real_T offset;
  real_T fsize;
  c1_USRP2FieldDtypes dtype;
  uint8_T bytes[16];
} c1_s7P91ApZ2CkwDPZE5FamWSB;

#else

typedef struct s7P91ApZ2CkwDPZE5FamWSB c1_s7P91ApZ2CkwDPZE5FamWSB;
...
typedef struct s6AmiQ3Zcve7MnsJ9ypFbFH
{
  ...
  uint8_T packetCount;
  uint16_T packetSize;
} c1_s6AmiQ3Zcve7MnsJ9ypFbFH;

#else

typedef struct s6AmiQ3Zcve7MnsJ9ypFbFH c1_s6AmiQ3Zcve7MnsJ9ypFbFH;
...
typedef struct s69xIfXV5nXp8sDnVHzDOMB
{
  ...
  uint8_T hasTrailer;
  uint32_T trailer;
  c1_s6AmiQ3Zcve7MnsJ9ypFbFH stream;
} c1_s69xIfXV5nXp8sDnVHzDOMB;

#else

typedef struct s69xIfXV5nXp8sDnVHzDOMB c1_s69xIfXV5nXp8sDnVHzDOMB;

#endif

typedef struct {
  c1_s69xIfXV5nXp8sDnVHzDOMB c1_Tx;
  c1_sgyjHZtUMVZuM1aKBgGok1D c1_replyQueue[255];
  SimStruct *S;
  real_T c1_HOST_CONTROL_PORT;
  real_T c1_NetworkLib[137];
  real_T c1_USRP2_CONTROL_PORT;
  real_T c1_USRP2_IP_NUM[12];
  real_T c1_b_NetworkLib[137];
  real_T c1_c_NetworkLib[137];
  real_T c1_lastCF;
  real_T c1_lastDI;
  real_T c1_lastG;
  real_T c1_lastI;
  ...
  uint16_T c1_Y1;
  uint16_T c1_b_Y1;
  boolean_T c1_Tx_not_empty;
  boolean_T c1_ctrlReceiverBlocking_not_empty;
  boolean_T c1_ctrlReceiver_not_empty;
  boolean_T c1_ctrlSender_not_empty;
  boolean_T c1_lastCF_not_empty;
  boolean_T c1_lastDI_not_empty;
  boolean_T c1_lastG_not_empty;
  boolean_T c1_lastI_not_empty;
  boolean_T c1_lastQ_not_empty;
  boolean_T c1_replyId_not_empty;
  boolean_T c1_replyQueue_not_empty;
  uint8_T c1_Y0[255];
  uint8_T c1_b_Y0[255];
  uint8_T c1_is_active_c1_commsdrhw;
...
extern const mxArray *sf_c1_commsdrhw_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c1_commsdrhw_get_check_sum(mxArray *plhs[]);
extern void c1_commsdrhw_method_dispatcher(SimStruct *S, int_T method, void
  *data);
