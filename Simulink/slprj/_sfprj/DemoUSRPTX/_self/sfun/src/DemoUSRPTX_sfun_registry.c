...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_DemoUSRPTX_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_commsdrhw_process_check_sum_call( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_DemoUSRPTX_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  if (sf_commsdrhw_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_DemoUSRPTX_autoinheritance_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_commsdrhw_autoinheritance_info( int nlhs, mxArray *
    plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "DemoUSRPTX") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_DemoUSRPTX_autoinheritance_info(nlhs,plhs,2,newRhs);
  }

  if (strcmp(machineName, "commsdrhw") == 0) {
    const mxArray *newRhs[2] = { NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_commsdrhw_autoinheritance_info(nlhs,plhs,2,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_DemoUSRPTX_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_commsdrhw_get_eml_resolved_functions_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 3) {
  ...
  if (strcmp(machineName, "DemoUSRPTX") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_DemoUSRPTX_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
  ...
  if (strcmp(machineName, "commsdrhw") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_commsdrhw_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_DemoUSRPTX_method_dispatcher(SimStruct *S, unsigned int
  chartFileNumber, const char* specsCksum, int_T method, void *data);
extern unsigned int sf_commsdrhw_method_dispatcher(SimStruct *S, unsigned int
  chartFileNumber, const char* specsCksum, int_T method, void *data);
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"DemoUSRPTX")) {
    return(sf_DemoUSRPTX_method_dispatcher(simstructPtr,chartFileNumber,
            specsCksum,method,data));
  }

  if (!strcmp(machineName,"commsdrhw")) {
    return(sf_commsdrhw_method_dispatcher(simstructPtr,chartFileNumber,
            specsCksum,method,data));
  }
...
extern void DemoUSRPTX_terminator(void);
...
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    DemoUSRPTX_terminator();
    commsdrhw_terminator();
    sf_debug_terminate();
  }
...
extern void DemoUSRPTX_initializer(void);
extern void commsdrhw_initializer(void);
extern void DemoUSRPTX_register_exported_symbols(SimStruct* S);
extern void commsdrhw_register_exported_symbols(SimStruct* S);
extern void DemoUSRPTX_debug_initialize(void);
extern void commsdrhw_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  DemoUSRPTX_register_exported_symbols(S);
  commsdrhw_register_exported_symbols(S);
}
