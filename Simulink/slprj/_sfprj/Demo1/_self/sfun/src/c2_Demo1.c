...
static void sf_c2_Demo1(SFc2_Demo1InstanceStruct *chartInstance);
static void c2_chartstep_c2_Demo1(SFc2_Demo1InstanceStruct *chartInstance);
...
static void c2_eml_error(SFc2_Demo1InstanceStruct *chartInstance);
static void c2_emlrt_marshallIn(SFc2_Demo1InstanceStruct *chartInstance, const
  mxArray *c2_out, const char_T *c2_identifier, uint32_T c2_y[20]);
static void c2_b_emlrt_marshallIn(SFc2_Demo1InstanceStruct *chartInstance, const
...
static void c2_d_emlrt_marshallIn(SFc2_Demo1InstanceStruct *chartInstance, const
  mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, uint32_T c2_y[20]);
static uint8_T c2_e_emlrt_marshallIn(SFc2_Demo1InstanceStruct *chartInstance,
  const mxArray *c2_b_is_active_c2_Demo1, const char_T *c2_identifier);
static uint8_T c2_f_emlrt_marshallIn(SFc2_Demo1InstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_putbits(SFc2_Demo1InstanceStruct *chartInstance, int32_T
  ...
  *chartInstance)
{
  ...
  c2_c_u = chartInstance->c2_is_active_c2_Demo1;
  c2_d_y = NULL;
  ...
  const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_Demo1 = c2_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 2)), "is_active_c2_Demo1");
  sf_mex_destroy(&c2_u);
...
{
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  c2_chartstep_c2_Demo1(chartInstance);
}
  ...
  const mxArray *c2_b_is_active_c2_Demo1, const char_T *c2_identifier)
{
  ...
  c2_thisId.fIdentifier = c2_identifier;
  c2_thisId.fParent = NULL;
  c2_y = c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_is_active_c2_Demo1),
    &c2_thisId);
...
static const mxArray *sf_get_sim_state_info_c2_Demo1(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"out\",},{M[4],M[0],T\"prev_out\",S'l','i','p'{{M1x2[264 272],M[0],}}},{M[8],M[0],T\"is_active_c2_Demo1\",}}"
  };
...
{
  sf_c2_Demo1((SFc2_Demo1InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_Demo1(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_Demo1((SFc2_Demo1InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_Demo1();/* state var info */
...
extern void sf_internal_set_sim_state_c2_Demo1(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_Demo1((SFc2_Demo1InstanceStruct*)chartInfo->chartInstance,
...
{
  return sf_internal_get_sim_state_c2_Demo1(S);
}

static void sf_opaque_set_sim_state_c2_Demo1(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_Demo1(S, st);
}
...
static void mdlProcessParameters_c2_Demo1(SimStruct *S)
{
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_Demo1((SFc2_Demo1InstanceStruct*)(((ChartInfoStruct *)
...
static void mdlSetWorkWidths_c2_Demo1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"Demo1","Demo1",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"Demo1","Demo1",2,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"Demo1","Demo1",2,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"Demo1","Demo1",2,1);
      sf_mark_chart_reusable_outputs(S,"Demo1","Demo1",2,1);
    }

    sf_set_rtw_dwork_info(S,"Demo1","Demo1",2);
...
static void mdlRTW_c2_Demo1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Demo1", "Demo1",2);
...
static void mdlStart_c2_Demo1(SimStruct *S)
{
  ...
  chartInstance = (SFc2_Demo1InstanceStruct *)malloc(sizeof
