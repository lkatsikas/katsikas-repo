...
static void initialize_c13_Demo1(SFc13_Demo1InstanceStruct *chartInstance);
static void initialize_params_c13_Demo1(SFc13_Demo1InstanceStruct *chartInstance);
static void enable_c13_Demo1(SFc13_Demo1InstanceStruct *chartInstance);
static void disable_c13_Demo1(SFc13_Demo1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c13_Demo1(SFc13_Demo1InstanceStruct
  *chartInstance);
static void set_sim_state_c13_Demo1(SFc13_Demo1InstanceStruct *chartInstance,
  const mxArray *c13_st);
static void finalize_c13_Demo1(SFc13_Demo1InstanceStruct *chartInstance);
static void sf_c13_Demo1(SFc13_Demo1InstanceStruct *chartInstance);
static void c13_chartstep_c13_Demo1(SFc13_Demo1InstanceStruct *chartInstance);
static void initSimStructsc13_Demo1(SFc13_Demo1InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c13_machineNumber, uint32_T
  c13_chartNumber);
static void c13_info_helper(c13_ResolvedFunctionInfo c13_info[16]);
static void c13_eml_error(SFc13_Demo1InstanceStruct *chartInstance);
static void c13_emlrt_marshallIn(SFc13_Demo1InstanceStruct *chartInstance, const
  mxArray *c13_out, const char_T *c13_identifier, uint32_T c13_y[20]);
static void c13_b_emlrt_marshallIn(SFc13_Demo1InstanceStruct *chartInstance,
  const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId, uint32_T c13_y
  [20]);
static void c13_c_emlrt_marshallIn(SFc13_Demo1InstanceStruct *chartInstance,
  const mxArray *c13_b_prev_out, const char_T *c13_identifier, uint32_T c13_y[20]);
static void c13_d_emlrt_marshallIn(SFc13_Demo1InstanceStruct *chartInstance,
  const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId, uint32_T c13_y
  [20]);
static uint8_T c13_e_emlrt_marshallIn(SFc13_Demo1InstanceStruct *chartInstance,
  const mxArray *c13_b_is_active_c13_Demo1, const char_T *c13_identifier);
static uint8_T c13_f_emlrt_marshallIn(SFc13_Demo1InstanceStruct *chartInstance,
  const mxArray *c13_u, const emlrtMsgIdentifier *c13_parentId);
static void c13_putbits(SFc13_Demo1InstanceStruct *chartInstance, int32_T
...
static void init_dsm_address_info(SFc13_Demo1InstanceStruct *chartInstance);
...
static void initialize_c13_Demo1(SFc13_Demo1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c13_is_active_c13_Demo1 = 0U;
  ...
  *chartInstance)
{
  ...
  c13_c_u = chartInstance->c13_is_active_c13_Demo1;
  c13_d_y = NULL;
  ...
  const mxArray *c13_st)
{
  ...
  chartInstance->c13_is_active_c13_Demo1 = c13_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c13_u, 2)), "is_active_c13_Demo1");
...
{
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  c13_chartstep_c13_Demo1(chartInstance);
}
...
const mxArray *sf_c13_Demo1_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c13_b_is_active_c13_Demo1, const char_T *c13_identifier)
{
  ...
  c13_y = c13_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c13_b_is_active_c13_Demo1), &c13_thisId);
  sf_mex_destroy(&c13_b_is_active_c13_Demo1);
  return c13_y;
}
...
/* SFunction Glue Code */
void sf_c13_Demo1_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c13_Demo1_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c13_Demo1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"out\",},{M[4],M[0],T\"prev_out\",S'l','i','p'{{M1x2[264 272],M[0],}}},{M[8],M[0],T\"is_active_c13_Demo1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c13_Demo1_get_check_sum(&mxChecksum);
  mxSetField(mxInfo, 0, infoFields[0], mxChecksum);
  mxSetField(mxInfo, 0, infoFields[1], mxVarInfo);
  return mxInfo;
}

static void sf_opaque_initialize_c13_Demo1(void *chartInstanceVar)
{
  initialize_params_c13_Demo1((SFc13_Demo1InstanceStruct*) chartInstanceVar);
  initialize_c13_Demo1((SFc13_Demo1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c13_Demo1(void *chartInstanceVar)
{
  enable_c13_Demo1((SFc13_Demo1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c13_Demo1(void *chartInstanceVar)
{
  disable_c13_Demo1((SFc13_Demo1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c13_Demo1(void *chartInstanceVar)
{
  sf_c13_Demo1((SFc13_Demo1InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c13_Demo1(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c13_Demo1((SFc13_Demo1InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c13_Demo1();/* state var info */
...
extern void sf_internal_set_sim_state_c13_Demo1(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c13_Demo1((SFc13_Demo1InstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c13_Demo1(SimStruct* S)
{
  return sf_internal_get_sim_state_c13_Demo1(S);
}

static void sf_opaque_set_sim_state_c13_Demo1(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c13_Demo1(S, st);
}

static void sf_opaque_terminate_c13_Demo1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc13_Demo1InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c13_Demo1((SFc13_Demo1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc13_Demo1((SFc13_Demo1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c13_Demo1(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c13_Demo1((SFc13_Demo1InstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c13_Demo1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"Demo1","Demo1",13);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"Demo1","Demo1",13,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"Demo1","Demo1",13,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"Demo1","Demo1",13,1);
      sf_mark_chart_reusable_outputs(S,"Demo1","Demo1",13,1);
    }

    sf_set_rtw_dwork_info(S,"Demo1","Demo1",13);
...
static void mdlRTW_c13_Demo1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Demo1", "Demo1",13);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c13_Demo1(SimStruct *S)
{
  SFc13_Demo1InstanceStruct *chartInstance;
  chartInstance = (SFc13_Demo1InstanceStruct *)malloc(sizeof
    (SFc13_Demo1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc13_Demo1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c13_Demo1;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c13_Demo1;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c13_Demo1;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c13_Demo1;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c13_Demo1;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c13_Demo1;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c13_Demo1;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c13_Demo1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c13_Demo1;
  chartInstance->chartInfo.mdlStart = mdlStart_c13_Demo1;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c13_Demo1;
...
void c13_Demo1_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c13_Demo1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c13_Demo1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c13_Demo1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c13_Demo1_method_dispatcher.\n"
