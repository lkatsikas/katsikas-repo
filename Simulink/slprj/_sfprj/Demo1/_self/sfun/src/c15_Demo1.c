...
static void initialize_c15_Demo1(SFc15_Demo1InstanceStruct *chartInstance);
static void initialize_params_c15_Demo1(SFc15_Demo1InstanceStruct *chartInstance);
static void enable_c15_Demo1(SFc15_Demo1InstanceStruct *chartInstance);
static void disable_c15_Demo1(SFc15_Demo1InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c15_Demo1(SFc15_Demo1InstanceStruct
  *chartInstance);
static void set_sim_state_c15_Demo1(SFc15_Demo1InstanceStruct *chartInstance,
  const mxArray *c15_st);
static void finalize_c15_Demo1(SFc15_Demo1InstanceStruct *chartInstance);
static void sf_c15_Demo1(SFc15_Demo1InstanceStruct *chartInstance);
static void c15_chartstep_c15_Demo1(SFc15_Demo1InstanceStruct *chartInstance);
static void initSimStructsc15_Demo1(SFc15_Demo1InstanceStruct *chartInstance);
...
static void c15_eml_error(SFc15_Demo1InstanceStruct *chartInstance);
static void c15_emlrt_marshallIn(SFc15_Demo1InstanceStruct *chartInstance, const
  mxArray *c15_out, const char_T *c15_identifier, uint32_T c15_y[20]);
static void c15_b_emlrt_marshallIn(SFc15_Demo1InstanceStruct *chartInstance,
  const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId, uint32_T c15_y
  [20]);
static void c15_c_emlrt_marshallIn(SFc15_Demo1InstanceStruct *chartInstance,
  const mxArray *c15_b_prev_out, const char_T *c15_identifier, uint32_T c15_y[20]);
static void c15_d_emlrt_marshallIn(SFc15_Demo1InstanceStruct *chartInstance,
  const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId, uint32_T c15_y
  [20]);
static uint8_T c15_e_emlrt_marshallIn(SFc15_Demo1InstanceStruct *chartInstance,
  const mxArray *c15_b_is_active_c15_Demo1, const char_T *c15_identifier);
static uint8_T c15_f_emlrt_marshallIn(SFc15_Demo1InstanceStruct *chartInstance,
  const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void c15_putbits(SFc15_Demo1InstanceStruct *chartInstance, int32_T
...
static void init_dsm_address_info(SFc15_Demo1InstanceStruct *chartInstance);
...
static void initialize_c15_Demo1(SFc15_Demo1InstanceStruct *chartInstance)
{
  ...
  chartInstance->c15_is_active_c15_Demo1 = 0U;
  ...
  *chartInstance)
{
  ...
  c15_c_u = chartInstance->c15_is_active_c15_Demo1;
  c15_d_y = NULL;
  ...
  const mxArray *c15_st)
{
  ...
  chartInstance->c15_is_active_c15_Demo1 = c15_e_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c15_u, 2)), "is_active_c15_Demo1");
...
{
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  c15_chartstep_c15_Demo1(chartInstance);
}
...
const mxArray *sf_c15_Demo1_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c15_b_is_active_c15_Demo1, const char_T *c15_identifier)
{
  ...
  c15_y = c15_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c15_b_is_active_c15_Demo1), &c15_thisId);
  sf_mex_destroy(&c15_b_is_active_c15_Demo1);
  return c15_y;
}
...
/* SFunction Glue Code */
void sf_c15_Demo1_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c15_Demo1_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c15_Demo1(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"out\",},{M[4],M[0],T\"prev_out\",S'l','i','p'{{M1x2[264 272],M[0],}}},{M[8],M[0],T\"is_active_c15_Demo1\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c15_Demo1_get_check_sum(&mxChecksum);
  mxSetField(mxInfo, 0, infoFields[0], mxChecksum);
  mxSetField(mxInfo, 0, infoFields[1], mxVarInfo);
  return mxInfo;
}

static void sf_opaque_initialize_c15_Demo1(void *chartInstanceVar)
{
  initialize_params_c15_Demo1((SFc15_Demo1InstanceStruct*) chartInstanceVar);
  initialize_c15_Demo1((SFc15_Demo1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c15_Demo1(void *chartInstanceVar)
{
  enable_c15_Demo1((SFc15_Demo1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c15_Demo1(void *chartInstanceVar)
{
  disable_c15_Demo1((SFc15_Demo1InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c15_Demo1(void *chartInstanceVar)
{
  sf_c15_Demo1((SFc15_Demo1InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c15_Demo1(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c15_Demo1((SFc15_Demo1InstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c15_Demo1();/* state var info */
...
extern void sf_internal_set_sim_state_c15_Demo1(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c15_Demo1((SFc15_Demo1InstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c15_Demo1(SimStruct* S)
{
  return sf_internal_get_sim_state_c15_Demo1(S);
}

static void sf_opaque_set_sim_state_c15_Demo1(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c15_Demo1(S, st);
}

static void sf_opaque_terminate_c15_Demo1(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc15_Demo1InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c15_Demo1((SFc15_Demo1InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc15_Demo1((SFc15_Demo1InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c15_Demo1(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c15_Demo1((SFc15_Demo1InstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c15_Demo1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"Demo1","Demo1",15);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"Demo1","Demo1",15,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"Demo1","Demo1",15,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"Demo1","Demo1",15,1);
      sf_mark_chart_reusable_outputs(S,"Demo1","Demo1",15,1);
    }

    sf_set_rtw_dwork_info(S,"Demo1","Demo1",15);
...
static void mdlRTW_c15_Demo1(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "Demo1", "Demo1",15);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c15_Demo1(SimStruct *S)
{
  SFc15_Demo1InstanceStruct *chartInstance;
  chartInstance = (SFc15_Demo1InstanceStruct *)malloc(sizeof
    (SFc15_Demo1InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc15_Demo1InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c15_Demo1;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c15_Demo1;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c15_Demo1;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c15_Demo1;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c15_Demo1;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c15_Demo1;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c15_Demo1;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c15_Demo1;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c15_Demo1;
  chartInstance->chartInfo.mdlStart = mdlStart_c15_Demo1;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c15_Demo1;
...
void c15_Demo1_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c15_Demo1(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c15_Demo1(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c15_Demo1(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c15_Demo1_method_dispatcher.\n"
