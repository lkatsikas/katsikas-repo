...
static const mxArray *c1_f_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real32_T c1_g_emlrt_marshallIn(SFc1_untitledInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_g_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static uint32_T c1_h_emlrt_marshallIn(SFc1_untitledInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[16]);
static void c1_putbits(SFc1_untitledInstanceStruct *chartInstance, int32_T
...
static void c1_eml_error(SFc1_untitledInstanceStruct *chartInstance);
static void c1_b_putbits(SFc1_untitledInstanceStruct *chartInstance, int32_T
  c1_bitpos, uint32_T c1_out[15], uint32_T c1_Temp, real_T c1_outpos, real32_T
  c1_val, real_T c1_bits, real_T *c1_flag, int32_T *c1_bitposO, uint32_T
  c1_outO[15], uint32_T *c1_TempO, real_T *c1_outposO);
static void c1_c_putbits(SFc1_untitledInstanceStruct *chartInstance, int32_T
  c1_bitpos, uint32_T c1_out[15], uint32_T c1_Temp, real_T c1_outpos, real_T
  c1_val, real_T c1_bits, real_T *c1_flag, int32_T *c1_bitposO, uint32_T
  c1_outO[15], uint32_T *c1_TempO, real_T *c1_outposO);
static uint8_T c1_i_emlrt_marshallIn(SFc1_untitledInstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_untitled, const char_T *c1_identifier);
static uint8_T c1_j_emlrt_marshallIn(SFc1_untitledInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
  ...
  const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_untitled = c1_i_emlrt_marshallIn(chartInstance,
...
static const mxArray *sf_get_sim_state_info_c1_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"out\",},{M[4],M[0],T\"prev_out\",S'l','i','p'{{M1x2[264 272],M[0],}}},{M[8],M[0],T\"is_active_c1_untitled\",}}"
  };
