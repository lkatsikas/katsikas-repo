...
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static real32_T c2_emlrt_marshallIn(SFc2_untitledInstanceStruct *chartInstance,
  const mxArray *c2_bits, const char_T *c2_identifier);
static real32_T c2_b_emlrt_marshallIn(SFc2_untitledInstanceStruct *chartInstance,
  const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static uint8_T c2_c_emlrt_marshallIn(SFc2_untitledInstanceStruct *chartInstance,
  ...
  *chartInstance)
{
  ...
  c2_b_u = chartInstance->c2_is_active_c2_untitled;
  c2_c_y = NULL;
  ...
  const mxArray *c2_st)
{
  ...
  *c2_bits = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
    0)), "bits");
  chartInstance->c2_is_active_c2_untitled = c2_c_emlrt_marshallIn(chartInstance,
...
static const mxArray *sf_get_sim_state_info_c2_untitled(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"bits\",},{M[8],M[0],T\"is_active_c2_untitled\",}}"
  };
...
static void mdlSetWorkWidths_c2_untitled(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"untitled","untitled",2,1);
      sf_mark_chart_reusable_outputs(S,"untitled","untitled",2,1);
    }
