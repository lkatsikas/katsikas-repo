...
static void initialize_c15_YCbCrTesting(SFc15_YCbCrTestingInstanceStruct
  *chartInstance);
static void initialize_params_c15_YCbCrTesting(SFc15_YCbCrTestingInstanceStruct *
  chartInstance);
static void enable_c15_YCbCrTesting(SFc15_YCbCrTestingInstanceStruct
  *chartInstance);
static void disable_c15_YCbCrTesting(SFc15_YCbCrTestingInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c15_YCbCrTesting
  (SFc15_YCbCrTestingInstanceStruct *chartInstance);
static void set_sim_state_c15_YCbCrTesting(SFc15_YCbCrTestingInstanceStruct
  *chartInstance, const mxArray *c15_st);
static void finalize_c15_YCbCrTesting(SFc15_YCbCrTestingInstanceStruct
  *chartInstance);
static void sf_c15_YCbCrTesting(SFc15_YCbCrTestingInstanceStruct *chartInstance);
static void c15_chartstep_c15_YCbCrTesting(SFc15_YCbCrTestingInstanceStruct
  *chartInstance);
static void initSimStructsc15_YCbCrTesting(SFc15_YCbCrTestingInstanceStruct
  *chartInstance);
...
static void c15_eml_error(SFc15_YCbCrTestingInstanceStruct *chartInstance);
static void c15_emlrt_marshallIn(SFc15_YCbCrTestingInstanceStruct *chartInstance,
  const mxArray *c15_out, const char_T *c15_identifier, uint32_T c15_y[20]);
static void c15_b_emlrt_marshallIn(SFc15_YCbCrTestingInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId,
  uint32_T c15_y[20]);
static void c15_c_emlrt_marshallIn(SFc15_YCbCrTestingInstanceStruct
  *chartInstance, const mxArray *c15_b_prev_out, const char_T *c15_identifier,
  uint32_T c15_y[20]);
static void c15_d_emlrt_marshallIn(SFc15_YCbCrTestingInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId,
  uint32_T c15_y[20]);
static uint8_T c15_e_emlrt_marshallIn(SFc15_YCbCrTestingInstanceStruct
  *chartInstance, const mxArray *c15_b_is_active_c15_YCbCrTesting, const char_T *
  c15_identifier);
static uint8_T c15_f_emlrt_marshallIn(SFc15_YCbCrTestingInstanceStruct
  *chartInstance, const mxArray *c15_u, const emlrtMsgIdentifier *c15_parentId);
static void c15_putbits(SFc15_YCbCrTestingInstanceStruct *chartInstance, int32_T
...
static void init_dsm_address_info(SFc15_YCbCrTestingInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c15_is_active_c15_YCbCrTesting = 0U;
  ...
  (SFc15_YCbCrTestingInstanceStruct *chartInstance)
{
  ...
  c15_c_u = chartInstance->c15_is_active_c15_YCbCrTesting;
  c15_d_y = NULL;
  ...
  *chartInstance, const mxArray *c15_st)
{
  ...
  chartInstance->c15_is_active_c15_YCbCrTesting = c15_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c15_u, 2)),
     "is_active_c15_YCbCrTesting");
...
{
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  c15_chartstep_c15_YCbCrTesting(chartInstance);
}
...
const mxArray *sf_c15_YCbCrTesting_get_eml_resolved_functions_info(void)
{
  ...
  c15_identifier)
{
  ...
  c15_y = c15_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c15_b_is_active_c15_YCbCrTesting), &c15_thisId);
  sf_mex_destroy(&c15_b_is_active_c15_YCbCrTesting);
  return c15_y;
}
...
/* SFunction Glue Code */
void sf_c15_YCbCrTesting_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c15_YCbCrTesting_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c15_YCbCrTesting(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"out\",},{M[4],M[0],T\"prev_out\",S'l','i','p'{{M1x2[264 272],M[0],}}},{M[8],M[0],T\"is_active_c15_YCbCrTesting\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c15_YCbCrTesting_get_check_sum(&mxChecksum);
  mxSetField(mxInfo, 0, infoFields[0], mxChecksum);
  mxSetField(mxInfo, 0, infoFields[1], mxVarInfo);
  return mxInfo;
}

static void sf_opaque_initialize_c15_YCbCrTesting(void *chartInstanceVar)
{
  initialize_params_c15_YCbCrTesting((SFc15_YCbCrTestingInstanceStruct*)
    chartInstanceVar);
  initialize_c15_YCbCrTesting((SFc15_YCbCrTestingInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c15_YCbCrTesting(void *chartInstanceVar)
{
  enable_c15_YCbCrTesting((SFc15_YCbCrTestingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c15_YCbCrTesting(void *chartInstanceVar)
{
  disable_c15_YCbCrTesting((SFc15_YCbCrTestingInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c15_YCbCrTesting(void *chartInstanceVar)
{
  sf_c15_YCbCrTesting((SFc15_YCbCrTestingInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c15_YCbCrTesting(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c15_YCbCrTesting
    ((SFc15_YCbCrTestingInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c15_YCbCrTesting();/* state var info */
...
extern void sf_internal_set_sim_state_c15_YCbCrTesting(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c15_YCbCrTesting((SFc15_YCbCrTestingInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c15_YCbCrTesting(SimStruct* S)
{
  return sf_internal_get_sim_state_c15_YCbCrTesting(S);
}

static void sf_opaque_set_sim_state_c15_YCbCrTesting(SimStruct* S, const mxArray
  *st)
{
  sf_internal_set_sim_state_c15_YCbCrTesting(S, st);
}

static void sf_opaque_terminate_c15_YCbCrTesting(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc15_YCbCrTestingInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c15_YCbCrTesting((SFc15_YCbCrTestingInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc15_YCbCrTesting((SFc15_YCbCrTestingInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c15_YCbCrTesting(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c15_YCbCrTesting(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"YCbCrTesting","YCbCrTesting",15);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"YCbCrTesting","YCbCrTesting",15,
                "RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"YCbCrTesting",
      "YCbCrTesting",15,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"YCbCrTesting","YCbCrTesting",15,1);
      sf_mark_chart_reusable_outputs(S,"YCbCrTesting","YCbCrTesting",15,1);
    }

    sf_set_rtw_dwork_info(S,"YCbCrTesting","YCbCrTesting",15);
...
static void mdlRTW_c15_YCbCrTesting(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "YCbCrTesting", "YCbCrTesting",15);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c15_YCbCrTesting(SimStruct *S)
{
  SFc15_YCbCrTestingInstanceStruct *chartInstance;
  chartInstance = (SFc15_YCbCrTestingInstanceStruct *)malloc(sizeof
    (SFc15_YCbCrTestingInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc15_YCbCrTestingInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c15_YCbCrTesting;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c15_YCbCrTesting;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c15_YCbCrTesting;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c15_YCbCrTesting;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c15_YCbCrTesting;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c15_YCbCrTesting;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c15_YCbCrTesting;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c15_YCbCrTesting;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c15_YCbCrTesting;
  chartInstance->chartInfo.mdlStart = mdlStart_c15_YCbCrTesting;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c15_YCbCrTesting;
...
void c15_YCbCrTesting_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c15_YCbCrTesting(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c15_YCbCrTesting(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c15_YCbCrTesting(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c15_YCbCrTesting_method_dispatcher.\n"
