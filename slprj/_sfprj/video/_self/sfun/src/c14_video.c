...
static void initialize_c14_video(SFc14_videoInstanceStruct *chartInstance);
static void initialize_params_c14_video(SFc14_videoInstanceStruct *chartInstance);
static void enable_c14_video(SFc14_videoInstanceStruct *chartInstance);
static void disable_c14_video(SFc14_videoInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c14_video(SFc14_videoInstanceStruct
  *chartInstance);
static void set_sim_state_c14_video(SFc14_videoInstanceStruct *chartInstance,
  const mxArray *c14_st);
static void finalize_c14_video(SFc14_videoInstanceStruct *chartInstance);
static void sf_c14_video(SFc14_videoInstanceStruct *chartInstance);
static void initSimStructsc14_video(SFc14_videoInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c14_machineNumber, uint32_T
  c14_chartNumber);
static real32_T c14_emlrt_marshallIn(SFc14_videoInstanceStruct *chartInstance,
  const mxArray *c14_bits, const char_T *c14_identifier);
static real32_T c14_b_emlrt_marshallIn(SFc14_videoInstanceStruct *chartInstance,
  const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static uint8_T c14_c_emlrt_marshallIn(SFc14_videoInstanceStruct *chartInstance,
  const mxArray *c14_b_is_active_c14_video, const char_T *c14_identifier);
static uint8_T c14_d_emlrt_marshallIn(SFc14_videoInstanceStruct *chartInstance,
  const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId);
static void init_dsm_address_info(SFc14_videoInstanceStruct *chartInstance);

/* Function Definitions */
static void initialize_c14_video(SFc14_videoInstanceStruct *chartInstance)
{
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  chartInstance->c14_is_active_c14_video = 0U;
}
  ...
  *chartInstance)
{
  ...
  c14_b_u = chartInstance->c14_is_active_c14_video;
  c14_c_y = NULL;
  ...
  const mxArray *c14_st)
{
  ...
  *c14_bits = c14_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c14_u, 0)), "bits");
  chartInstance->c14_is_active_c14_video = c14_c_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c14_u, 1)), "is_active_c14_video");
...
static void sf_c14_video(SFc14_videoInstanceStruct *chartInstance)
{
  ...
  real32_T *c14_bits;
  real32_T (*c14_b_in)[64];
  c14_bits = (real32_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c14_b_in = (real32_T (*)[64])ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  c14_numacbits = 0.0;
  c14_run = 0.0;
  if ((real_T)(*c14_b_in)[0] < 0.0) {
    c14_f0 = -(*c14_b_in)[0];
    if ((c14_f0 < 8.388608E+6F) && (c14_f0 > -8.388608E+6F)) {
      c14_f0 = c14_f0 < 0.0F ? muSingleScalarCeil(c14_f0 - 0.5F) :
        muSingleScalarFloor(c14_f0 + 0.5F);
    }

    if (c14_f0 < 4.2949673E+9F) {
      if (c14_f0 >= 0.0F) {
        c14_dcval = (uint32_T)c14_f0;
      } else {
        c14_dcval = 0U;
      }
    } else if (c14_f0 >= 4.2949673E+9F) {
  ...
  for (c14_b_i = 0; c14_b_i < 63; c14_b_i++) {
    c14_guard1 = FALSE;
    if ((real_T)c14_in[c14_b_i + 1] == 0.0) {
      c14_run++;
      if (c14_b_i + 1 < 63) {
      } else {
        c14_guard1 = TRUE;
...
const mxArray *sf_c14_video_get_eml_resolved_functions_info(void)
{
  ...
  const mxArray *c14_u, const emlrtMsgIdentifier *c14_parentId)
{
  real32_T c14_y;
  real32_T c14_f1;
  sf_mex_import(c14_parentId, sf_mex_dup(c14_u), &c14_f1, 1, 1, 0U, 0, 0U, 0);
  c14_y = c14_f1;
  sf_mex_destroy(&c14_u);
  return c14_y;
}
  ...
  const mxArray *c14_b_is_active_c14_video, const char_T *c14_identifier)
{
  ...
  c14_y = c14_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c14_b_is_active_c14_video), &c14_thisId);
  sf_mex_destroy(&c14_b_is_active_c14_video);
  return c14_y;
}
...
/* SFunction Glue Code */
void sf_c14_video_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c14_video_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c14_video(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"bits\",},{M[8],M[0],T\"is_active_c14_video\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c14_video_get_check_sum(&mxChecksum);
  mxSetField(mxInfo, 0, infoFields[0], mxChecksum);
  mxSetField(mxInfo, 0, infoFields[1], mxVarInfo);
  return mxInfo;
}

static void sf_opaque_initialize_c14_video(void *chartInstanceVar)
{
  initialize_params_c14_video((SFc14_videoInstanceStruct*) chartInstanceVar);
  initialize_c14_video((SFc14_videoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c14_video(void *chartInstanceVar)
{
  enable_c14_video((SFc14_videoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c14_video(void *chartInstanceVar)
{
  disable_c14_video((SFc14_videoInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c14_video(void *chartInstanceVar)
{
  sf_c14_video((SFc14_videoInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c14_video(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c14_video((SFc14_videoInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c14_video();/* state var info */
...
extern void sf_internal_set_sim_state_c14_video(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c14_video((SFc14_videoInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c14_video(SimStruct* S)
{
  return sf_internal_get_sim_state_c14_video(S);
}

static void sf_opaque_set_sim_state_c14_video(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c14_video(S, st);
}

static void sf_opaque_terminate_c14_video(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc14_videoInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c14_video((SFc14_videoInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc14_video((SFc14_videoInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c14_video(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c14_video((SFc14_videoInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c14_video(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"video","video",14);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"video","video",14,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"video","video",14,
      "gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"video","video",14,1);
      sf_mark_chart_reusable_outputs(S,"video","video",14,1);
    }

    sf_set_rtw_dwork_info(S,"video","video",14);
...
static void mdlRTW_c14_video(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "video", "video",14);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c14_video(SimStruct *S)
{
  SFc14_videoInstanceStruct *chartInstance;
  chartInstance = (SFc14_videoInstanceStruct *)malloc(sizeof
    (SFc14_videoInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc14_videoInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c14_video;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c14_video;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c14_video;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c14_video;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c14_video;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c14_video;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c14_video;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c14_video;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c14_video;
  chartInstance->chartInfo.mdlStart = mdlStart_c14_video;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c14_video;
...
void c14_video_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c14_video(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c14_video(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c14_video(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c14_video_method_dispatcher.\n"
