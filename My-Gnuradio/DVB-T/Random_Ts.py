...
class QAM16(gr.top_block, Qt.QWidget):
	...
	def __init__(self):
		...
		#--------------------------------------------------------------------------------------------------------------#
                #with open('/home/katsikas/katsikas-repo/Gnuradio/Common/Text.txt', 'rb') as file:
			#self.gr_vector_source_0 = gr.vector_source_b(self.ts,False,1)
                with open('/home/katsikas/katsikas-repo/Simulink/Korgialas_GeiaSou.ts', 'rb') as file:
                        self.gr_vector_source_0 = dvbt.dvbt_source(file,self.Packets_Number)
                #--------------------------------------------------------------------------------------------------------------#
