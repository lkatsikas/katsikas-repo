...
class QAM16(gr.top_block, Qt.QWidget):
	...
	def __init__(self):
		...
		self.gr_file_source_0 = gr.file_source(gr.sizeof_char*256, "/home/katsikas/katsikas-repo/My-Gnuradio/Common/Korgialas_GeiaSou.ts", True)
		self.gr_file_sink_0 = gr.file_sink(gr.sizeof_char*256, "/home/katsikas/katsikas-repo/My-Gnuradio/Common/Results.ts")
